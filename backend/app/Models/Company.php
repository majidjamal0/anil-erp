...
class Company extends Model
{
    ...
    protected $fillable = ['name','legal_name','code','national_id','economic_code','phone','email','address','logo_path','default_locale','default_currency','timezone','is_active','settings'];
    ...
    public function warehouseTypes(): HasMany { return $this->hasMany(WarehouseType::class); }
    public function salesChannels(): HasMany { return $this->hasMany(SalesChannel::class); }
